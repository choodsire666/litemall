...
public class ResponseUtil {
    ...
    /**
     * 如果list是ArrayList则就返回一页，否则就是分页显示。
     * @param list
     * @return
     */
    ...
    /**
     * 带分页的列表, pagedList可能是Page，也可能是ArrayList。
     * @param list
     * @param pagedList
     * @return
     */
    ...
    /**
     * 即后端采用了乐观锁更新，而并发更新时存在数据更新失效
     * @return
     */
    public static Object updatedDataExpired() {
        return fail(504, "更新数据已失效");
    }

    /**
     * 即后端数据库更新失败（正常情况应该更新成功）。
     * @return
     */
    ...
    public static Object unathz() {
        return fail(506, "无权限操作");
    }
}
